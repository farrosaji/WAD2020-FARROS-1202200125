...
if (isset($_COOKIE["email"]) && isset($_COOKIE["password"])) {
  ...
  $result = mysqli_query($koneksi, "SELECT * FROM users_farros WHERE email = '$email'");
...
if (isset($_POST["login"])) {
  ...
  $query = mysqli_query($koneksi, "SELECT * FROM users_farros WHERE email='$email'");  
  ...
  <section id="login">
    <div class="container-fluid">
      <div class="row align-items-center">
        <div class="col-md-4 min-vh-50 left">
          <img src="../asset/images/avanza.jfif" style="object-fit:fill;height:50%;" alt="foto">
        </div>
        <div class="col-md-6">
          <div class="form-login m-auto ps-5">
            ...
            <form action="" method="post">
              ...
              <div class="text-center text-lg-start mt-4 pt-2">
                ...
                <p class="small fw-bold mt-2 pt-1 mb-0">belum punya akun <a href="Register.php" class="link-danger">Daftar</a></p>
              </div>
            </form>
          </div>
        </div>
