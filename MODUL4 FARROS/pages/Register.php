...
if (isset($_POST["daftar"])) {
  ...
  $no_hp = $_POST["no"];
  $result = mysqli_query($koneksi, "SELECT email FROM users_farros WHERE email = '$email'");

  if (mysqli_num_rows(($result)) !== 1 && $password == $pwdConfirm) {
    $password = password_hash($password, PASSWORD_DEFAULT);
    mysqli_query($koneksi, "INSERT INTO users_farros (nama, email, password, no_hp) VALUES ('$nama', '$email', '$password', '$no_hp')");
  ...
  <section id="login">
    <div class="container-fluid">
      <div class="row align-items-center">
        <div class="col-md-6 min-vh-50 left">
          <img src="../asset/images/avanza.jfif" style="object-fit:fill; height:100%;" alt="foto">
        </div>
        <div class="col-md-6">
